<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="RegistroCalificaciones.aspx.cs" Inherits="PROYECTO_UX.Views.Registros.RegistroCalificaciones.RegistroCalificaciones" %>
        ...
        <div class="row justify-content-center">
            <div class="col-auto">
                <div class="table-responsive">
                    <asp:GridView runat="server" ID="gvCalificaciones" CssClass="table table-bordered table-hover">
                        <Columns>
